...
```{r, ind-train-progress, fig.cap='Trainingsfortschritte im Falle unabhängiger Modelle', fig.height=3, echo=FALSE, message=FALSE, warning = FALSE} 
...
```{r, dep-train-progress, fig.cap='Trainingsfortschritte im Falle unabhängiger Modelle', fig.height=3, echo=FALSE, message=FALSE, warning = FALSE} 
