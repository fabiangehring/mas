...
``` {r, example-nearest-neighbor-outlook, fig.cap='Exemplarische Kursprognose auf Basis nächster Nachhbarn', fig.heigth=3, fig.pos = '!H',  echo=FALSE, message=FALSE, warning=FALSE}
k <- 5
curr_idx <- 432100
...
``` {r, knn-learning-history, fig.cap='Entwicklung der Modellperformance über die Zeit', fig.height=3, fig.pos = '!H', echo=FALSE, message=FALSE, warning=FALSE}
