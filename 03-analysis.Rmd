...
# arrow::write_feather(data, "data/data_wide_3.feather")
...
train_data <- as.matrix(select(data_wide_3[train_idx, ], -Ticker, -Date))
  train_labels <- data_wide_3_all[train_idx, ]$Close_0

test_data <- as.matrix(select(data_wide_3[test_idx, ], -Ticker, -Date))
test_labels <- data_wide_3_all[test_idx, ]$Close_0
