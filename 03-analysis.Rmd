...
id <- 1234
test_data <- data_wide_0[1:3000000, setdiff(names(data_wide_0), paste0(c("Open", "Low", "High", "Close"), "_", 0))] 
test_dates <- quotes_line$Date[1:3000000]
rm(data_wide_0, quotes_line)

out <- find_nn(test_data, dates = test_dates, mc.cores = 4)
