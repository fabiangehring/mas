...
hist_pred_train_path <- "data/steps/hist_pred_train.feather"
if (!file.exists(hist_pred_train_path)) {
  ...
  write_feather(hist_pred_train, "data/steps/hist_pred_train.feather")
} else {
...
nn_factors_eucl <- calc_nn_factors(
  data = data_knn_3_incl_0, 
  factor_config = factor_config, 
  nn_idx = nn_3_eucl_idx, 
  use_spread = FALSE, 
...
nn_factors_eucl_spread <- calc_nn_factors(
  data = data_knn_3_incl_0, 
  factor_config = factor_config, 
  nn_idx = nn_3_eucl_idx, 
  use_spread = TRUE, 
