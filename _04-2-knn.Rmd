...
Da es sehr unwahrscheinlich ist, die genau gleichen Kursverläufe in der Histore wiederzufinden, muss ein Distanzmass definiert werden, welches die Ähnlichkeit der Verläufe quantifiziert. Sei dafür jeder Kursverlauf $i$ als Vektor $hist_{i_t}$ notiert. 

$$ hist_{i, t} = (Open_{i, t}, High_{i, t}, Low_{j, t+1}, Close_{i, t+1}, Open_{i, t+1}, ..., Close_{i, 1}, Open_{i, 0}) $$

Der Index $t$ gibt dabei an, wieviele Tage der Vergangenheit mit einbezogen werden. Ein Index von 0 bezieht sich auf den zu prognostizierenden, aktuellen Tag. Um die Ähnlichkeit zweier Einträge $i$ und $j$ zu berechnen, bieten sich zwei Distanzmasse an:
