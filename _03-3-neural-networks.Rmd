...
```{r nn-indipendent-categorical-plotting}
...
hist_data_low <- eval_hist_data(ind_categorical_discretization_low$borders, low_prob, "Low")
hist_data_high <- eval_hist_data(ind_categorical_discretization_high$borders, high_prob, "High")
hist_data_close <- eval_hist_data(ind_categorical_discretization_close$borders, close_prob, "Close")
plot_price_histogram(bind_rows(hist_data_low, hist_data_high, hist_data_close), "Some test")
