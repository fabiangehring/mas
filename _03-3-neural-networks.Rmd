...
sample_idx <- seq_len(5000)
ind_categorical_buy_sell <- find_optimal_buy_sell(ind_categorical, data_wide_3_all, both_first, test_idx, sample_idx)
```

#### Mit Berücksichtigung der Ordinalität

```{r nn-indipendent-binary, echo=FALSE}
ind_binary <- get_neural_model(data_wide_3_all, type = "ind", crossentropy = "binary")

```

```{r nn-indipendent-binary-plotting, fig.cap='Histogramm prognostizierter Tiefst-, Höchst- und Schlusspreise', fig.asp=1, fig.pos = '!H',}
