...
test <- find_best_buy_sell(
  low_prob = ind_categorical_models$low_pred_prob,
  high_prob = ind_categorical_models$high_pred_prob,
  close_prob = ind_categorical_models$close_pred_prob,
