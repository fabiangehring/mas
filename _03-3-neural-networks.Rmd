...
ind_categorical <- get_neural_model(data_wide_3_all, type = "ind", crossentropy = "categorical")
...
optimal_buy_sell_idx <- find_optimal_buy_sell(
  ...
  both_first = both_first[test_idx][seq_len(sample_n)],
  mc.cores = 3
)
...
```{r nn-indipendent-binary-training, echo=FALSE}
ind_categorical <- get_nn_model(data_wide_3_all, type = "ind", crossentropy = "categorical")
