...
Die Höhe des Gewinnes lässt sich auch mathematisch fomulieren. Bezeichnen dazu $S_0$ den Preis des Underlying und $P_0$ den Preis der Option zu Beginn und $S_1$ sowie $P_1$ die jeweiligen Preise nach einer Preisbewegung des Unerlyings um $d_S$. $\Delta_0$ und $\Gamma_0$ bezeichnen die erste und zweite Ableitung des Optionspreises zum Ausgangszeitpunkt. Ferner sei als $\Delta_{Cash} = \Delta \times S$ der Wert des Hedge Portfolio bezeichnet und $\Gamma_{Cash} = \Gamma \times S²/100$ bezeichne die Veränderung des $\Delta_{Cash}$ bei einer 1-prozentigen Veränderung des Underlying-Preises. Dies lässt sich anhand folgender Überlegungen herleiten: Verändert sich der Underlying-Preis um 1% $S => S + S / 100$, verändert sich auch das Delta $\Delta => \Delta + \Gamma \times S/100$. Das neue Delta Cash verändert sich damit in der Höhe von Gamma Cash $\Delta_{Cash} => \Delta_{Cash} + \Gamma \times S²/100$.
...
1. Etwas umgeformt lässt sich der Gewinn schreiben als: $\Gamma_0 \times dS² / 2 = \Gamma_0 \times S² /100 * dS² / S² * 100 = \Gamma_{Cash} \times (dS/S)² \times 100$ 
