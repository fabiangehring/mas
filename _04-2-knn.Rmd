...
``` {r, example-nearest-neighbor-outlook, fig.cap='Exemplarische Kursprognose auf Basis nächster Nachhbarn', fig.heigth=4, fig.pos = '!H',  echo=FALSE, message=FALSE, warning=FALSE}
k <- 5
curr_idx <- 432100
