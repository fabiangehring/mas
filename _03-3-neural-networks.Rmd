...
ind_binary <- get_neural_model_ind(data_wide_3_all, architecture = "2_dense_512", crossentropy = "binary")
```
...
```{r nn-indipendent-categorical-training, echo=FALSE}
ind_categorical <- get_neural_model_dep(data_wide_3_all, architecture = "2_dense_512", crossentropy = "categorical", n_groups_per_col = 10)
```
