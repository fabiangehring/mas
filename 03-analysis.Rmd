...
low_win_3_bin_100 <- fit_categorical_model(data_wide_3_all, data_wide_3, train_idx, test_idx, "Low_0", 100)
# save_model_hdf5(low_win_3_bin_100$model, "models/low_win_3_bin_100_model.hdf5")
saveRDS(low_win_3_bin_100$history, "data/low_win_3_bin_100_history.hdf5")
low_win_3_bin_100$model <- load_model_hdf5("data/low_win_3_bin_100_model.hdf5")

high_win_3_bin_100 <- fit_categorical_model(data_wide_3_all, data_wide_3, train_idx, test_idx, "high_0", 100)
# save_model_hdf5(high_win_3_bin_100$model, "models/high_win_3_bin_100_model.hdf5")
saveRDS(high_win_3_bin_100$history, "data/high_win_3_bin_100_history.hdf5")
high_win_3_bin_100$model <- load_model_hdf5("data/high_win_3_bin_100_model.hdf5")

close_win_3_bin_100 <- fit_categorical_model(data_wide_3_all, data_wide_3, train_idx, test_idx, "close_0", 100)
# save_model_hdf5(close_win_3_bin_100$model, "models/close_win_3_bin_100_model.hdf5")
saveRDS(close_win_3_bin_100$history, "data/close_win_3_bin_100_history.hdf5")
close_win_3_bin_100$model <- load_model_hdf5("data/close_win_3_bin_100_model.hdf5")
...
pred_prob_low <- predict_proba(model_low, test_data[curr_eval_id, , drop = FALSE], batch_size = 1024)
...
pred_prob_high <- predict_proba(model_high, test_data[curr_eval_id, , drop = FALSE], batch_size = 1024)
...
sum(calc_payoff_const_gamma(test, buy = 97, sell = 103, both_first = both_first))
  ...
  low_binary_100 <- fit_binary_model(data_wide_3_all, data_wide_3, train_idx, test_idx, "Low_0", 100)
  save_model_hdf5(low_binary_100$model, "data/low_binary_100_model.hdf5")
  saveRDS(low_binary_100$history, "data/low_binary_100_history.hdf5")
  
  high_binary_100 <- fit_binary_model(data_wide_3_all, data_wide_3, train_idx, test_idx, "High_0", 100)
  save_model_hdf5(high_binary_100$model, "data/high_binary_100_model.hdf5")
  saveRDS(high_binary_100$history, "data/high_binary_100_history.hdf5")
