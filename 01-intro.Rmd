...
Eine Transaktion wird dabei ausgeführt ($I_{first}$, resp. $I_{second}$) wenn beide der folgenden Bedingungen erfüllt sind:

a) der Preis im Laufe des Tages erreicht wird
b) die jeweils vorangegangene Transaktion bei einem höheren Preis (Kauf), resp. tieferen Preis (Verkauf) stattgefunden hat.
