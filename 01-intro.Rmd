...
## Daten
Als Datengrundlage dienen historische Eröffnungs-, Tiefst-, Höchst und Schlusskurse von Aktien (nachfolgend auch Open, Low, High und Close genannt) groser Unternehmen. Diese sind öffentlich und können von Yahoo Finance bezogen werden. Die Verwendung öffentlicher Daten hat den Vorteil, dass diese problemlos auf Cloud-Infrastruktur (beispielsweise unabdingbar im Falle des Einsatzes von Neuronalen Netze / Deep Learning Techniken) prozessiert werden können, ohne dass dabei Lizenzvereinbarungen berücksichtigt werden müssen. 

## Methoden
Es werden nachfolgend verschiedene Methoden zur Optimierung des Payoffs ausprobiert und gegeneinander verglichen. Diese sind: 
