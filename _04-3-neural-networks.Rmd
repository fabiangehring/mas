...
ind_categorical_spread <- get_neural_model_ind(data_wide_10, architecture = "2_dense_512", crossentropy = "binary", spread = TRUE, n_groups_per_col = 9)
...
test_data <- shorten_data(data_wide_10[test_idx, ])

ind_categorical_payoff_spread <- calc_payoff_const_gamma(
  quotes_line = data_wide_10[test_idx, ], 
