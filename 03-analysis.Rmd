...
```{r, keras-combined-individual-categorial, echo=FALSE}
...
model_low <- fit_categorical_model(data_wide_3_all, data_wide_3, train_idx, test_idx, "Low_0", 10)
save_model_hdf5(model_high, "data/model_low.hdf5")

model_high <- fit_categorical_model(data_wide_3_all, data_wide_3, train_idx, test_idx, "High_0", 10)
save_model_hdf5(model_high, "data/model_high.hdf5")

model_close <- fit_categorical_model(data_wide_3_all, data_wide_3, train_idx, test_idx, "Close_0", 10)
save_model_hdf5(model_close, "data/model_close.hdf5")
