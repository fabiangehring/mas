...
model_cat_low <- fit_model_cat(x[train_idx, ], y_low[train_idx], 5)
saveRDS(model_cat_low, "data/models/ind/categorical/2_dense_512/model_low.rds")

model_cat_high <- fit_model_cat(x[train_idx, ], y_high[train_idx], 5)
saveRDS(model_cat_high, "data/models/ind/categorical/2_dense_512/model_high.rds")

model_cat_close <- fit_model_cat(x[train_idx, ], y_close[train_idx], 5)
saveRDS(model_cat_close, "data/models/ind/categorical/2_dense_512/model_close.rds")
