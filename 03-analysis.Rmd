...
nn_pred <- pred_nn(select(data_wide_0, c("Low_0", "High_0")), nn_idx = nn$nn.idx)
na_row_bool <- rowSums(is.na(nn_pred)) > 0

nn_pred_sample <- nn_pred[!na_row_bool, ]

quotes_line_sample <- quotes_line[seq_len(n), ][!na_row_bool, ]
