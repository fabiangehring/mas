...
## Daten
Als Datengrundlage stehen historische Eröffnungs-, Tiefst-, Höchst und Schlusskurse Aktienpreise (nachfolgend auch Open, Low, High und Close genannt) zur Verfügung. Diese sind öffentlich und können von Yahoo Finance bezogen werden. So kommen 9.5 Mio. historische Datenpunkte für die grössten rund 1600 Unternehmen weltweit zusammen. Die Rohdaten scheinen grundsätzlich plausibel, gewisse Datenbereinigungsschritte sind aber nötig. 

Die Verwendung öffentlicher Daten hat den Vorteil, dass diese problemlos auf Cloud-Infrastruktur (beispielsweise unabdingbar im Falle des Einsatzes von Neuronalen Netze / Deep Learning Techniken) prozessiert werden können, ohne dabei Lizenzvereinbarungen berücksichtigen zu müssen. 
