...
ind_categorical_model_paths <- paste0("models/", ind_categorical_model_names, ".hdf5")

if (all(ind_categorical_model_paths, file.exists)) {
  ...
  write_csv(ind_categorical_labels[train_idx, ], "data/ind_categorical_labels_train.csv")
  write_csv(select(data_wide_3, -Ticker, -Date), "data/ind_categorical_data_train.csv")
