...
eucl_table_paths <- c("data/knn/eucl_table.feather", "data/knn/manh_table.feather")
if (all(map_lgl(eucl_table_paths, !file.exists(.)))) {
  ...
  write_feather(eucl_table, eucl_table_paths[1])
  ...
  write_feather(manh_table, eucl_table_paths[2])
  
  
} else {
  eucl_table <- read_feather(eucl_table_paths[1])
  eucl_table <- read_feather(eucl_table_paths[2])
}
